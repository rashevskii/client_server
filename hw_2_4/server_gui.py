...
def gui_create_model(database):
    ...
    list_table.setHorizontalHeaderLabels(['Client name', 'IP Address', 'Port', 'Time of connection'])
...
def create_stat_model(database):
    ...
    list_table.setHorizontalHeaderLabels(
        ['Client name', 'Last visit', 'Message send', 'Message get'])
...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.ip_label = QLabel('From what IP we accept connections:', self)
...
if __name__ == '__main__':
    ...
    test_list.setHorizontalHeaderLabels(['Client name', 'IP Address', 'Port', 'Time of connection'])
    test_list.appendRow(
